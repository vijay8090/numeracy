...
<div class="container">
	...
	<p class="btn-info">Manage Lesson</p>
	<div ng-app="myApp">
    ...
    <option value="-1" >Select Status</option>
					...
					<tr>
						...
						<td><textarea type='text' name='longdesc' ng-model="fields.longdesc" class='form-control' maxlength="1000" required></textarea></td>
						
					</tr>
					
					<tr>
						<td>Short Description</td>
						<td><textarea type='text' name='shortdesc' ng-model="fields.shortdesc" class='form-control' maxlength="250" required></textarea></td>
					
					</tr>
					
					<tr>
						<td>Additional Info</td>
						<td><textarea type='text' name='additionalinfo' ng-model="fields.additionalinfo" class='form-control' maxlength="500" required></textarea></td>
	...
	var url =  "../controller/lessonController.php";
//ui-grid-cellnav
	...
	//$scope.gridOptions = { enableRowSelection: true, enableRowHeaderSelection: false };
			 ...
			 // $scope.gridApi.selection.setMultiSelect(true);
			  ...
			  $scope.gridOptions.columnDefs = [
			    ...
			    { name: 'm05lessonid', displayName: 'S.No', enableCellEdit: false,width: 70, visible:false  },
			    { name: 'title', displayName: 'Title', width: 300  },			    
			    { name: 'longdesc', displayName: 'Long Desc',width: 200},
			    { name: 'shortdesc', displayName: 'Short Desc',width: 200},
				{ name: 'additionalinfo', displayName: 'Additional Info', width: 200 },
		           ...
		           $scope.gridApi = gridApi;
		            ...
		            gridApi.edit.on.afterCellEdit($scope,function(rowEntity, colDef, newValue, oldValue){
		              // $scope.msg.lastCellEdited = 'edited row id:' + rowEntity.id + ' Column:' + colDef.name + ' newValue:' + newValue + ' oldValue:' + oldValue ;
		               ...
		               $scope.msg.updateVal.id=rowEntity.m05lessonid;
            ...
            $scope.master = {title:"Title-", longdesc:"", shortdesc:"", additionalinfo:"", m11statusid:6};
            ...
            $scope.myData.deleteFn = function() {
            	...
            	angular.forEach($scope.gridApi.selection.getSelectedRows(), function (data, index) {
            	   ...
            	   // alert("deletemsg "+ data.id);
            	      $scope.myData.selectedids.push(data.m05lessonid);
            	  });
