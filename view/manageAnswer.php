...
<div class="container">
	...
	<p class="btn-info">Manage Answer</p>
	<div ng-app="myApp">
		<div ng-controller="myCtrl">
			...
			<form name="f1" method='post' action="#">
				...
				<table class='table table-bordered table-hover table-striped'>
					...
					<tr>
						<td>Text Answer</td>
						<td><textarea type='text' name='textanswer' ng-model="fields.textanswer" class='form-control' maxlength="100" required></textarea></td>
	...
	var url =  "../controller/answerController.php";
//ui-grid-cellnav
	...
	//$scope.gridOptions = { enableRowSelection: true, enableRowHeaderSelection: false };
			 ...
			 // $scope.gridApi.selection.setMultiSelect(true);
			  ...
			  $scope.gridOptions.columnDefs = [
			    ...
			    { name: 'm13answerid', displayName: 'S.No', enableCellEdit: false,width: 70, visible:false  },
			    { name: 'active', displayName: 'Active', width: 200  },			    
			    { name: 'description', displayName: 'Description',width: 300},
				{ name: 'textanswer', displayName: 'Text Answer',width: 200},
		           ...
		           $scope.gridApi = gridApi;
		            ...
		            gridApi.edit.on.afterCellEdit($scope,function(rowEntity, colDef, newValue, oldValue){
		              // $scope.msg.lastCellEdited = 'edited row id:' + rowEntity.id + ' Column:' + colDef.name + ' newValue:' + newValue + ' oldValue:' + oldValue ;
		               ...
		               $scope.msg.updateVal.id=rowEntity.m13answerid;
            ...
            $scope.master = {description:"", active:"", textanswer:"", m11statusid:6};
            ...
            $scope.myData.deleteFn = function() {
            	...
            	angular.forEach($scope.gridApi.selection.getSelectedRows(), function (data, index) {
            	   ...
            	   // alert("deletemsg "+ data.id);
            	      $scope.myData.selectedids.push(data.m13answerid);
            	  });
